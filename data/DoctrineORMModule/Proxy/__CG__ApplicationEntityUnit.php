 ...
 */
class Unit extends \Application\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Unit' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Unit' . "\0" . 'initials'];
        }
